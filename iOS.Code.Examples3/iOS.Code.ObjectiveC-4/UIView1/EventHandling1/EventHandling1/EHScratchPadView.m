...
@implementation EHScratchPadView
{
...
- (void) initCommon
{
	_toolType = EHScratchPadToolTypePaint;
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	if (self.toolType == EHScratchPadToolTypePaint) {
		[self paintTouchesBegan];
	}
	if (self.toolType == EHScratchPadToolTypeAirBrush) {
