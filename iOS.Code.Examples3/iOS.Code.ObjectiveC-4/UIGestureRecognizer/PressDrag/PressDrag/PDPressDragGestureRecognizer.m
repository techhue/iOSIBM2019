//
//  PDPressDragGestureRecognizer .m
//  PressDrag
//
...
@interface PDPressDragGestureRecognizer  ()
...
@implementation PDPressDragGestureRecognizer 
...
- (NSString *)description {
    return [NSString stringWithFormat:@"PDPressDragGestureRecognizer  didLongPress=%i anchorPoint=(%f, %f) dragPoint(%f, %f)", self.didLongPress, self.anchorPoint.x, self.anchorPoint.y, self.dragPoint.x, self.dragPoint.y];
}
